<div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900 dark:text-white">
        Selamat datang di aplikasi STUDENT BSI
    </h1>
...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">
                <a href="{{ route('announcement') }}">Pengumuman Terbaru</a>
            </h2>
        </div>
        ...
        <p class="mt-4 text-sm">
            <a href="{{ route('announcement') }}" class="inline-flex items-center font-semibold text-indigo-700 dark:text-indigo-300">
                Selengkapnya
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">
                <a href="#">Playlist Konten Pembelajaran</a>
            </h2>
        </div>

        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
        Video pembelajaran adalah media untuk mentransfer pengetahuan dan dapat digunakan sebagai bagian dari proses belajar. Lebih interaktif dan lebih spesifik dari sebuah buku atau kuliah, tutorial berusaha untuk mengajar dengan contoh dan memberikan informasi untuk menyelesaikan tugas tertentu.</p>
